																							...
																							<td class="node-cell" colspan="2">
																								<div class="${ styles.node }">
																									<div class="${ styles.card }">
																										...
																										<div class="${ styles.photo }">
																											<div>
																												<img src="https://dikuw-4642a56ed1cad9.sharepoint.com/sites/develop_apps/OrgChart/Lists/Pictures/1.png">
																											</div>
																										</div>
																										<div class="${ styles.cardFooter }">
																											<i title="Add new underneath" class="fa fa-plus-circle" data-dept="5" data-id="14"></i>
																											<i title="Email: null" class="fa fa-envelope-o" data-email="null"></i>
																											<i title="Call: null" class="fa fa-phone" data-phone="null"></i>
																											<i title="Call: null" class="fa fa-mobile" data-mobile="null"></i>
																											<i title="Expand/Collapse children" class="fa fa-arrows-v" style="display: none;"></i>
																											<i title="Open context menu" class="fa fa-ellipsis-h" style="grid-column:span 2 / auto;" data-id="14"></i>
																										</div>
																									</div>
																								</div>
																							</td>
